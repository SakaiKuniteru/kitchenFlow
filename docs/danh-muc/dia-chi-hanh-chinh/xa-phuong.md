...
Cấp địa chỉ chi tiết trực thuộc tỉnh/thành.

## 2. Bảng dữ liệu

- Bảng chính: `dm_xa_phuong`

## 3. Logic nghiệp vụ

Tỉnh/thành cha bắt buộc; mã xã/phường duy nhất; xã/phường phải thuộc đúng tỉnh/thành; bản ghi bị khóa không dùng cho địa chỉ mới.
