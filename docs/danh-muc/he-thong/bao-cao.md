...
Khai báo mẫu báo cáo/xuất dữ liệu của hệ thống.

## 2. Bảng dữ liệu

- Bảng chính: `dm_bao_cao`

## 3. Logic nghiệp vụ

Mã báo cáo phải duy nhất; loại xuất file dùng enum 10/20/30; bản ghi bị khóa không dùng cho xuất mới; file mẫu chỉ là cấu hình, logic sinh file nằm ở module export.
