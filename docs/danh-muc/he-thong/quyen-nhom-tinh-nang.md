# Liên kết Quyền - Nhóm tính năng

## 1. Ý nghĩa

Gom quyền theo nhóm tính năng.

## 2. Bảng dữ liệu

- Bảng chính: `dm_quyen_nhom_tinh_nang`

## 3. Logic nghiệp vụ

Cặp quyền-nhóm là duy nhất; chỉ dùng liên kết active; bảng này để tổ chức quyền, không phải bảng cấp quyền cho vai trò.
