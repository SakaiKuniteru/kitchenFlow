...
Lưu cấu hình hệ thống theo mã, có thể áp dụng theo cơ sở.

## 2. Bảng dữ liệu

- Bảng chính: `dm_thiet_lap`

## 3. Logic nghiệp vụ

Mã thiết lập duy nhất; cơ sở nếu có phải tồn tại; giá trị lưu dạng text và được parse/validate theo từng mã; updated_at được cập nhật khi sửa.
