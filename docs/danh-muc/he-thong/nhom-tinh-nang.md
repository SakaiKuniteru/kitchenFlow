...
Gom quyền và thiết lập theo module/tính năng.

## 2. Bảng dữ liệu

- Bảng chính: `dm_nhom_tinh_nang`

## 3. Logic nghiệp vụ

Mã nhóm duy nhất; nhóm quyền qua dm_quyen_nhom_tinh_nang; nhóm thiết lập qua dm_thiet_lap_nhom_tinh_nang; nhóm bị khóa không dùng cho cấu hình mới.
