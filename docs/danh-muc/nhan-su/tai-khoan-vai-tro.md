# Liên kết Tài khoản - Vai trò

## 1. Ý nghĩa

Gán vai trò trực tiếp cho tài khoản.

## 2. Bảng dữ liệu

- Bảng chính: `dm_tai_khoan_vai_tro`

## 3. Logic nghiệp vụ

Khóa chính ghép tài khoản-vai trò; không trùng cặp; cần thống nhất với dm_nhan_vien_vai_tro để tránh hai nguồn vai trò mâu thuẫn.
