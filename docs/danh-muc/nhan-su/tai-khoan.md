...
Lưu thông tin đăng nhập và trạng thái bảo mật của người dùng.

## 2. Bảng dữ liệu

- Bảng chính: `dm_tai_khoan`

## 3. Logic nghiệp vụ

Một nhân viên một tài khoản; tên đăng nhập duy nhất; mật khẩu hiện hash MD5; sai mật khẩu tăng bộ đếm và có thể khóa tạm; đăng nhập thành công reset lỗi, cập nhật lần đăng nhập, sinh access/refresh token; lần đầu buộc đổi mật khẩu.
