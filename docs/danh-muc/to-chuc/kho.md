...
Khai báo kho lưu trữ thực phẩm của từng nhà ăn.
...
Nhà ăn bắt buộc và phải hợp lệ; mã/tên kiểm tra trùng; nhiệt độ tối đa không nhỏ hơn tối thiểu; repository trả kèm nhà ăn, cơ sở, địa chỉ; kho bị khóa không dùng cho phiếu mới.
