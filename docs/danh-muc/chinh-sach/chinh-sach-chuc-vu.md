# Liên kết Chính sách - Chức vụ

## 1. Ý nghĩa

Xác định chính sách áp dụng theo chức vụ.

## 2. Bảng dữ liệu

- Bảng chính: `ct_chinh_sach_chuc_vu`

## 3. Logic nghiệp vụ

Không nên tạo trùng cặp; chỉ áp dụng khi chính sách, chức vụ và liên kết đều active.
