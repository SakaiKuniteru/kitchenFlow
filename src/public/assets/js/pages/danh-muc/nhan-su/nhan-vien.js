...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const API_GIOI_TINH =
        "/api/mcs/v1/enums?name=gioiTinh";
    ...
    function mapListRecord(
        ...
        return {
            ...
            tenTinhThanh:
                record?.tenTinhThanh ||
                record?.tinhThanh?.tenTinhThanh ||
                record?.tinhThanh?.ten ||
                "",

            tenXaPhuong:
                record?.tenXaPhuong ||
                record?.xaPhuong?.tenXaPhuong ||
                record?.xaPhuong?.ten ||
                ""
        };
    }
    ...
    function buildDateTimeWithTimezone(
        value
    ) {
