...
document.addEventListener(
    ...
    () => {
                        ...
                        .createCatalogPage({
                            ...
                            validation: {
                                maXaPhuong: {
                                    ...
                                    maxLengthMessage:
                                        "Mã xã phường không được vượt quá 50 ký tự.",
                                    uniqueMessage:
        ...
        function fillQuocGiaByTinhThanhId(
            tinhThanhId
        ) {
            const maQuocGiaInput =
                document
                    .getElementById(
                        "maQuocGia"
                    );

            const tenQuocGiaInput =
                document
                    .getElementById(
                        "tenQuocGia"
                    );
