...
(function initializeSidebar() {
    ...
    function updateExpandToggle() {
        ...
        expandToggleButton.dataset.mode =
            hasOpen
                ? "collapse"
                : "expand";
