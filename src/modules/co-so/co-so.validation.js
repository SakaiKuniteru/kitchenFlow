...
const createSchema = Joi.object({
    ...
    tenCoSo: Joi.string()
        ...
        .messages({
            "string.base":
                "Tên cơ sở phải là chuỗi.",
            "string.empty":
                "Tên cơ sở không được để trống.",
            "string.max":
                "Tên cơ sở không được vượt quá 255 ký tự.",
            "any.required":
    ...
    logo: Joi.string()
        ...
        .messages({
            "string.base":
                "Logo phải là chuỗi.",
            "string.max":
                "Logo không được vượt quá 500 ký tự."
        }),
    ...
    favicon: Joi.string()
        ...
        .messages({
            "string.base":
                "Favicon phải là chuỗi.",
            "string.max":
                "Favicon không được vượt quá 500 ký tự."
        }),
    ...
    logoDoiTac: Joi.string()
        ...
        .messages({
            "string.base":
                "Logo đối tác phải là chuỗi.",
            "string.max":
                "Logo đối tác không được vượt quá 500 ký tự."
        }),
    ...
    maTinhThanh: Joi.string()
        ...
        .messages({
            "string.base":
                "Mã tỉnh/thành phải là chuỗi.",
            "string.empty":
                "Mã tỉnh/thành không được để trống.",
            "string.max":
                "Mã tỉnh/thành không được vượt quá 20 ký tự."
        }),
    ...
    .messages({
        "object.missing":
            "Mỗi cấp địa chỉ phải có ID hoặc mã tương ứng."
    });
