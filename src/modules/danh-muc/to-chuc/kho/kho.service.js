...
class KhoService {
    ...
    async chuanHoaLienKet(data) {
        ...
        if (duLieu.maNhaAn) {
            const nhaAn = await khoRepository.getNhaAnByMa(
                duLieu.maNhaAn
            );
    ...
    async validateLienKet(data) {
        ...
        if (
            !Number.isInteger(Number(data.nhaAnId)) ||
        ...
        const nhaAnTonTai = await khoRepository.existsNhaAn(
            data.nhaAnId
        );
    ...
    validateLoaiKho(loaiKho) {
        ...
        const hopLe = dsLoaiKho.some(
            item => Number(item.value) === giaTriSo
        );
    ...
    async validateTrungDuLieu(
        ...
        const trungMa = await khoRepository.existsMaKho(
            data.maKho,
            excludeId
        );
        ...
        const trungTen = await khoRepository.existsTenKho(
            data.tenKho,
            excludeId
        );
    ...
    async create(data) {
        ...
        const loaiKho = this.validateLoaiKho(
            duLieu.loaiKho
        );
        ...
        const duLieuTao = {
            ...
            nhietDoToiDa:
                duLieu.nhietDoToiDa !== undefined
                    ? Number(duLieu.nhietDoToiDa)
                    : null,
    ...
    async update(id, data) {
        ...
        duLieuDaChuanHoa.loaiKho = this.validateLoaiKho(
        ...
        if (duLieuDaChuanHoa.nhietDoToiDa !== null) {
            duLieuDaChuanHoa.nhietDoToiDa = Number(
                duLieuDaChuanHoa.nhietDoToiDa
            );
        }
        ...
        const ketQua = await khoRepository.update(
            khoId,
            duLieuDaChuanHoa
        );
