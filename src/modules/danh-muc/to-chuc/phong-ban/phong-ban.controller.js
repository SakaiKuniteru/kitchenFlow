...
class PhongBanController {
    async getTongHop(
        ...
        try {
            const data = await phongBanService.getTongHop(
                req.query
            );
    ...
    async getChiTiet(
        ...
        try {
            ...
            const data = await phongBanService.getChiTiet(
                id
            );
    ...
    async create(
        ...
        try {
            const data = await phongBanService.create(
                req.body
            );
    ...
    async update(
        ...
        try {
            ...
            const data = await phongBanService.update(
                id,
                req.body
            );
