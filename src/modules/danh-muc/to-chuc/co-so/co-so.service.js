...
class CoSoService {
    ...
    async chuanHoaDiaChi(data) {
        ...
        if (duLieu.maQuocGia) {
            const quocGiaTheoMa = await coSoRepository.getQuocGiaByMa(
                duLieu.maQuocGia
            );
        ...
        if (duLieu.maTinhThanh) {
            ...
            const tinhThanhTheoMa = await coSoRepository.getTinhThanhByMa(
                duLieu.maTinhThanh,
        ...
        if (duLieu.maXaPhuong) {
            ...
            const xaPhuongTheoMa = await coSoRepository.getXaPhuongByMa(
                duLieu.maXaPhuong,
    ...
    async validateDuLieu(data, excludeId = null) {
        ...
        const trungMa = await coSoRepository.existsMaCoSo(
            maCoSo,
            excludeId
        );
        ...
        const trungTen = await coSoRepository.existsTenCoSo(
            tenCoSo,
            excludeId
        );
        ...
        if (
            ...
            const quocGiaTonTai = await coSoRepository.existsQuocGia(
                quocGiaId
            );
        ...
        if (
            ...
            const tinhThanhTonTai = await coSoRepository.existsTinhThanh(
                tinhThanhId,
                quocGiaId
            );
        ...
        if (
            ...
            const xaPhuongTonTai = await coSoRepository.existsXaPhuong(
                xaPhuongId,
                tinhThanhId
            );
    ...
    async create(data, files) {
        ...
        try {
            ...
            if (logo) {
                const fileMoi = await coSoFileService.saveFile(
                    maCoSo,
                    "logo",
                    logo
                );
            ...
            if (logo) {
                await coSoFileService.cleanupOldFiles(
                    maCoSo,
                    "logo",
                    3
                );
            ...
            for (const file of danhSachFileMoi) {
                await coSoFileService.deletePhysicalFile(
                    file.fullPath
                );
            }
    ...
    async update(id, data, files) {
        ...
        try {
            ...
            const duLieuDaChuanHoa = await this.chuanHoaDiaChi(
                duLieuCapNhat
            );
            ...
            if (maCoSoCu !== maCoSoMoi) {
                await coSoFileService.renameCoSoDirectory(
                    maCoSoCu,
                    maCoSoMoi
                );

                duLieuDaChuanHoa.logo =
                    coSoFileService.replaceMaCoSoInPath(
                        duLieuDaChuanHoa.logo,
                        maCoSoCu,
                        maCoSoMoi
                    );
            ...
            const ketQua = await coSoRepository.update(
                coSoId,
                duLieuDaChuanHoa
            );
